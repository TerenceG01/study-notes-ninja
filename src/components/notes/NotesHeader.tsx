...
export const NotesHeader = ({
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-card p-6 rounded-lg shadow-lg border border-border/50 hover:shadow-xl transition-shadow">
        <div>
        ...
        <div className="flex items-center gap-4 w-full sm:w-auto">
          <div className="relative flex-1 sm:flex-initial sm:w-64">
            ...
            <Input placeholder="Search notes..." className="pl-10 shadow-sm hover:shadow transition-shadow" onChange={e => onSearch(e.target.value)} />
          </div>
          <Button
          ...
          <Button variant="outline" size="icon" className="hidden sm:flex shadow-sm hover:shadow transition-shadow">
