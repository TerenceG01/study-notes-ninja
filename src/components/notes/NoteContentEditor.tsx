...
export const NoteContentEditor = ({
  ...
  return (
    <div className="mt-2 mb-16 min-h-[150px] flex flex-col bg-card rounded-lg border border-border shadow-sm mx-auto w-full max-w-[90%] md:max-w-[85%] lg:max-w-[80%] overflow-hidden">
      {showSummary && editingNote?.summary ? (
        ...
        <div className="flex flex-col h-full flex-1 relative max-w-full overflow-hidden">
          ...
          <div className="flex justify-between items-center text-xs text-muted-foreground px-3 py-2 border-t border-border bg-card absolute bottom-0 left-0 right-0">
