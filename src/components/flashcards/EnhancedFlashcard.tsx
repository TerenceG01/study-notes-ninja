...
export const EnhancedFlashcard = ({ 
  ...
  return (
    <Card 
      className="w-full min-w-full sm:min-w-full md:min-w-full lg:min-w-full max-w-full h-[300px] sm:h-[350px] md:h-[400px] cursor-pointer transition-all hover:shadow-lg relative flex-shrink-0 overflow-hidden"
