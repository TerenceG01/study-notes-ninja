...
export const EnhancedFlashcard = ({ 
  ...
  return (
    <Card 
      className="w-full max-w-[800px] mx-auto h-[350px] cursor-pointer transition-all hover:shadow-lg relative flex-shrink-0"
      onClick={() => onFlip(!isFlipped)}
      {...swipeHandlers}
    >
      <CardContent className="flex items-center justify-center p-4 sm:p-6 md:p-8 h-full overflow-auto">
        <div className="text-lg sm:text-xl md:text-2xl font-medium text-center w-full">
